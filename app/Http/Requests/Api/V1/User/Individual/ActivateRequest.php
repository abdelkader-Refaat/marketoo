...
class ActivateRequest extends BaseApiRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'phone' => [
                'required', 'numeric', 'digits_between:9,10',
                Rule::exists('users', 'phone')->where('country_code', fixPhone($this->country_code))
            ],
    ...
    public function prepareForValidation()
    {
        ...
        $this->merge([
            ...
            'user' => User::query()->where([
                'phone' => $phone, 'country_code' => $country_code, 'type' => UserTypesEnum::INDIVIDUAL->value
            ])->first(),
        ]);
    }

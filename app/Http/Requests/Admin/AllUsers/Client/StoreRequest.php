...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'phone'                             => ['required', 'numeric', 'digits_between:9,10', Rule::unique('users', 'phone')->whereNull('deleted_at')],
            'email'                             => ['required', 'email:rfc,dns', Rule::unique('users', 'email')->whereNull('deleted_at'), 'max:50'],
